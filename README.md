...
- [docs/V1_MVP_边界.md](./docs/V1_MVP_边界.md)
- [docs/项目总览.md](./docs/项目总览.md)
...
当前 `codex/mvp-backend-v1` 分支采用“软收口”策略：

- 非 V1 能力代码保留
- 运行时通过 capability guard 默认关闭
- 带 `@post-mvp` 标记的接口与模块，不进入当前 V1 联调范围

补充说明：

- `CRM` 在这个分支里已经做了硬剔除，不再加载进应用运行时
