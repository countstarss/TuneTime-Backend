...
export class TeacherSubjectResponseDto {
  @ApiProperty({
    description: '老师科目关系 ID。',
    example: 'cmc123teacher-subject001',
  })
  id!: string;
...
export class TeacherCredentialResponseDto {
  ...
  @ApiProperty({
    description: '审核人用户 ID。',
    example: 'cmc123admin001',
    nullable: true,
    required: false,
  })
...
export class TeacherResponseDto {
  ...
  @ApiProperty({
    description: '服务区域列表。',
    type: TeacherServiceAreaResponseDto,
    isArray: true,
  })
  ...
  @ApiProperty({
    description: '可预约规则列表。',
    type: TeacherAvailabilityRuleResponseDto,
    isArray: true,
  })
  ...
  @ApiProperty({
    description: '资质材料列表。',
    type: TeacherCredentialResponseDto,
    isArray: true,
  })
